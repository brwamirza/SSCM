      ...
      <div>
        ...
        <div className="row">
          ...
          <div className="col-sm-4 grid-margin">
            <div className="card">
              <div className="card-body">
                <h5>Follower evolution percentage</h5>
                <div className="row">
                  <div className="col-8 col-sm-12 col-xl-8 my-auto">
                    <div className="d-flex d-sm-block d-md-flex align-items-center">
                      <h2 className="mb-0">5.4%</h2>
          ...
          <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <h6 className="text-muted font-weight-normal">Impressions</h6>
              </div>
            </div>
          </div>
          <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <h6 className="text-muted font-weight-normal">Reach</h6>
              </div>
            </div>
          </div>
          <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <h6 className="text-muted font-weight-normal">Average engagement rate per post</h6>
              </div>
            </div>
          </div>
          <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <h6 className="text-muted font-weight-normal">Average engagement on reach per post</h6>
              </div>
            </div>
          </div>
        </div>
